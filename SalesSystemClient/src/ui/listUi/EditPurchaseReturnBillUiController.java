...
public class EditPurchaseReturnBillUiController {
	@FXML
	...
	private PurchaseReturnBillVO currentBill=null;
	
	public void init(PurchaseReturnBillVO bill, String operation){
		currentBill=bill;

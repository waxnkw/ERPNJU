...
public class ViewGiftUiStarter {
   ...
   * 无参数构造方法
   */
	public ViewGiftUiStarter(PromotionUiForGiftsUiController controller){
	...
	*/
	public ViewGiftUiStarter(Stage stage,PromotionUiForGiftsUiController controller){
	...
	*/
	public void start(){
		try {
			URL location = getClass().getResource("ViewGiftUi.fxml");
			...
			//设置controller并且初始化
			ViewGiftUiController contoller = flLoader.getController();
			contoller.setViewPromotionUiController(this.controller);
			contoller.init();
			if(goods!=null){

...
public class ApprovePurchaseBillUiController {

	
	private static final String DEFAULT_APPROVER_COMENT = "总经理不想理你，并甩给你一张单据";
	private ObservableList<PurchaseBillVO> bills = FXCollections.observableArrayList();
	private UserInfoVO user;
	private ApprovePurchaseBillBlService service 
		= RemoteHelperFactory.getApproveBillRemoteHelper().getApprovePurchaseBillBlService(); 
	 ...
	 * */
	@FXML
	private TableView<PurchaseBillVO> billTableView;
	@FXML
	private TableColumn<PurchaseBillVO, String> billIdColumn;
	@FXML
	private TableColumn<PurchaseBillVO, String> billCreateDateColumn;
	@FXML
	private TableColumn<PurchaseBillVO, String> billCreaterColumn;
	@FXML
	private TableColumn<PurchaseBillVO, Button> viewBillColumn;	
	@FXML
	private TableColumn<PurchaseBillVO, CheckBox> chooseBillColumn;
	@FXML
	private TableColumn<PurchaseBillVO,Button> remarkTableColumn;
	@FXML
	private TableColumn<PurchaseBillVO, Button> assignTableColumn;
	...
	private void setViewBillColumn(){
		viewBillColumn.setCellValueFactory(cellDataFeatures->{
			...
			button.setOnMouseClicked(e->{
				PurchaseBillVO bill = (PurchaseBillVO)cellDataFeatures.getValue();
	...
	private void setRemarkTableColumn(){
		remarkTableColumn.setCellValueFactory(cellDataFeature->{
			...
			button.setOnMouseClicked(e->{
				PurchaseBillVO bill = (PurchaseBillVO)cellDataFeature.getValue();
	...
	private void initBillList(){
		ArrayList<PurchaseBillVO> PurchaseBills = new ArrayList<>();
		try {
			PurchaseBills = service.getBillsList();

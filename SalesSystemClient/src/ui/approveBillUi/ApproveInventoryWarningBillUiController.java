...
public class ApproveInventoryWarningBillUiController {

	
	private static final String DEFAULT_APPROVER_COMENT = "总经理不想理你，并甩给你一张单据";
	private ObservableList<InventoryWarningBillVO> bills = FXCollections.observableArrayList();
	private UserInfoVO user;
	private ApproveInventoryWarningBillBlService service 
		= RemoteHelperFactory.getApproveBillRemoteHelper().getApproveInventoryWarningBillBlService(); 
	 ...
	 * */
	@FXML
	private TableView<InventoryWarningBillVO> billTableView;
	@FXML
	private TableColumn<InventoryWarningBillVO, String> billIdColumn;
	@FXML
	private TableColumn<InventoryWarningBillVO, String> billCreateDateColumn;
	@FXML
	private TableColumn<InventoryWarningBillVO, String> billCreaterColumn;
	@FXML
	private TableColumn<InventoryWarningBillVO, Button> viewBillColumn;	
	@FXML
	private TableColumn<InventoryWarningBillVO, CheckBox> chooseBillColumn;
	@FXML
	private TableColumn<InventoryWarningBillVO,Button> remarkTableColumn;
	@FXML
	private TableColumn<InventoryWarningBillVO, Button> assignTableColumn;
	...
	private void setViewBillColumn(){
		viewBillColumn.setCellValueFactory(cellDataFeatures->{
			...
			button.setOnMouseClicked(e->{
				InventoryWarningBillVO bill = (InventoryWarningBillVO)cellDataFeatures.getValue();
	...
	private void setRemarkTableColumn(){
		remarkTableColumn.setCellValueFactory(cellDataFeature->{
			...
			button.setOnMouseClicked(e->{
				InventoryWarningBillVO bill = (InventoryWarningBillVO)cellDataFeature.getValue();
	...
	private void initBillList(){
		ArrayList<InventoryWarningBillVO> InventoryWarningBills = new ArrayList<>();
		try {
			InventoryWarningBills = service.getBillsList();
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		bills.addAll(InventoryWarningBills);
	}

...
public class ApproveGiftBillController {
	
	private static final String DEFAULT_APPROVER_COMENT = "总经理不想理你，并甩给你一张单据";
	private ObservableList<GiftBillVO> bills = FXCollections.observableArrayList();
	private UserInfoVO user;
	private ApproveGiftBillBlService service 
	 ...
	 * */
	@FXML
	private TableView<GiftBillVO> billTableView;
	@FXML
	private TableColumn<GiftBillVO, String> billIdColumn;
	@FXML
	private TableColumn<GiftBillVO, String> billCreateDateColumn;
	@FXML
	private TableColumn<GiftBillVO, String> billCreaterColumn;
	@FXML
	private TableColumn<GiftBillVO, Button> viewBillColumn;	
	@FXML
	private TableColumn<GiftBillVO, CheckBox> chooseBillColumn;
	@FXML
	private TableColumn<GiftBillVO,Button> remarkTableColumn;
	@FXML
	private TableColumn<GiftBillVO, Button> assignTableColumn;
	...
	private void setViewBillColumn(){
		viewBillColumn.setCellValueFactory(cellDataFeatures->{
			...
			button.setOnMouseClicked(e->{
				GiftBillVO bill = (GiftBillVO)cellDataFeatures.getValue();
	...
	private void setRemarkTableColumn(){
		remarkTableColumn.setCellValueFactory(cellDataFeature->{
			...
			button.setOnMouseClicked(e->{
				GiftBillVO bill = (GiftBillVO)cellDataFeature.getValue();
	...
	private void initBillList(){
		ArrayList<GiftBillVO> giftBills = new ArrayList<>();
		try {
			giftBills = service.getBillsList();

...
public class FinancialStaffBillStateBlService_Stub implements FinancialStaffBillStateBlService{
	...
	private CashExpenseBillVO newACashExpenseBill(){
		...
		maker1.setId("123456");
		Date date=new Date();
		CashExpenseBillVO bill1=new CashExpenseBillVO(maker1,"一号账户",entries,7500.0,
				"不想送货上门"
				,date);
	...
	private PaymentBillVO newAPaymentBill(){
		...
		maker1.setId("123456");
		Date date=new Date();
		PaymentBillVO bill1=new PaymentBillVO(maker1,"一号账户",entries,7500.0,
				"不想送货上门"
				,date);
		bill1.setApproveDate(new Date());
		UserInfoVO approver=new UserInfoVO();
	...
	private ReceiptBillVO newAReceiptBill(){
		...
		maker1.setId("123456");
		Date date=new Date();
		ReceiptBillVO bill1=new ReceiptBillVO(maker1,"一号账户",entries,7500.0,
				"不想送货上门",date);
		bill1.setApproveDate(new Date());
		UserInfoVO approver=new UserInfoVO();
		approver.setName("总经理");

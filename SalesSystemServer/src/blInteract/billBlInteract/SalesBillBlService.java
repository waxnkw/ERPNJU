...
public interface SalesBillBlService {
	 ...
	 * @return ArrayList<SalesBillPO>读取的进货单列表退货
	 */
	 ...
	 * @return ArrayList<SalesBillPO>读取的进货单草稿列表退货
	 */
	 ...
	 * @param userId 筛选的单据创建者的Id
	 * @param userRole 筛选的单据创建者的职位
	 * @return ArrayList<SalesBillPO>需要读取的未审批进货单列表退货
	 */
	 ...
	 * @param userId 筛选的单据创建者的Id
	 * @param userRole 筛选的单据创建者的职位
	 * @return ArrayList<SalesBillPO>读取的需要执行的进货单列表退货
	 */
	 ...
	 * @param userId 筛选的单据创建者的Id
	 * @param userRole 筛选的单据创建者的职位
	 * @return ArrayList<SalesBillPO>读取的审批未通过的进货单列表退货
	 */
	 ...
	 * @param userId 筛选的单据创建者的Id
	 * @param userRole 筛选的单据创建者的职位
	 * @return ArrayList<SalesBillPO>读取的已经完成的进货单列表退货
	 */
